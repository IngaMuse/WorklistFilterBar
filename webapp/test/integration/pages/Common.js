sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/WorklistFilterBar/app", ".html");
		...
		return Opa5.extend("zjblessons.WorklistFilterBar.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/WorklistFilterBar/localService/mockserver"], function (mockserver) {
